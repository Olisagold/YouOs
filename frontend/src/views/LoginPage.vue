...
<template>
  <div class="mx-auto w-full max-w-md space-y-6">
    <div class="space-y-2 text-center">
      ...
      <h1 class="text-3xl font-semibold text-[var(--text)]">Welcome back</h1>
      <p class="text-sm text-muted">Sign in to continue your disciplined command center.</p>
    </div>
    ...
    <p class="text-center text-sm text-muted">
      New here?
      <RouterLink class="ml-1 text-accent transition hover:text-[rgb(176,195,222)]" to="/register">
        Create an account
      </RouterLink>
    </p>
  </div>
